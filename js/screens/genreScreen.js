...
import countScreen from './countScreen.js';
import timeIsUpScreen from './timeIsUpScreen.js';
import {makeDOMElement, updateScreen, getRandomValue} from './../utils/misc.js';

// Игра на выбор жанра
const genreScreen = makeDOMElement(`
...
const submitButton = genreScreen.querySelector(`.genre-answer-send`);
